...
def main():
    ...
    with_opo = []
    with_both = []
    with open("accept_multiprocessor_2core.csv") as f:
    ...
    ax.legend(loc='lower left', bbox_to_anchor=(-0.01, 0.49), prop={'size': 20}, handlelength=3.0)
    plt.grid(axis='y')
    plt.tight_layout(pad=0)
    # plt.show()
    plt.savefig("accept_multiprocessor_2core.pdf")
